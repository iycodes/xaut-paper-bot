...
func Default() Config {
	return Config{
		...
		Funding:   FundingConfig{FallbackDailyRate: .0003, ExpectedHoldingHours: 8, MaximumEdgeShare: .20, MaximumAge: Duration{10 * time.Minute}, Lookback: Duration{6 * time.Hour}},
